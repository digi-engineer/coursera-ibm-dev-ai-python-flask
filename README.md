...
This the final lab for Coursera course ["Developing AI Applications with Python and Flask" by IBM](https://www.coursera.org/learn/python-project-for-ai-application-development/)

In this final lab, you will develop a web application integrated with Embeddable Watson AI libraries.
