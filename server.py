''' Executing this function initiates the application over the Flask channel
'''
...
def analyze_emotion():
    ''' This code receives the text from the HTML interface and runs emotion detection over it
        using emotion_detector() function. The output returned shows emotion list with scores.
    '''
